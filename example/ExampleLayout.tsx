...
import { FormValues, ThemeProvider, TreegeRenderer } from "@/renderer";
    ...
    <ThemeProvider theme={theme}>
      <div className="h-full flex flex-col bg-background">
        ...
        <div className="flex-1 overflow-auto p-6">
          {hasNodes ? (
            <>
              <TreegeRenderer nodes={nodes} edges={edges} onSubmit={handleSubmit} onChange={setFormValues} validationMode="onSubmit" />
