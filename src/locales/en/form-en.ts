const FORM_EN = {
  ...
  dynamicSelectStructureHint: "A dynamic select type must be:",
  email: "Email",
  ...
  keyPathObject: "Key path to value (string | number | object)",
  label: "Label",
  letter: "Letter",
  message: "Message",
  ...
  objectDemo: "Demo object mapping",
  ...
  staticValueDescription: "By default, it will render the ancestor value, but you can assign a static value.",
  step: "Step",
  tree: "Tree",
  treeName: "Tree name",
  type: {
