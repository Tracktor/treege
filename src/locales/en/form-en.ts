const FORM_EN = {
  ...
  label: "Label",
  letter: "Letter",
  mapObjectToRender: "Map the value of the object to display",
  message: "Message",
  ...
  receiveValueFromParent: "Pre-fill field from parent",
  ...
  value: "Value",
  valueOfParentIsOfType: "Value of parent is of type",
  values: "Values",
