...
const FormTreeCardMutation = ({ onClose, title, isOpen }: FormTreeCardMutationProps) => {
  ...
  return (
    <Dialog
      ...
      maxWidth={openSmartData ? "md" : "sm"}
      fullWidth
      scroll="paper"
    >
      <form onSubmit={handleSubmit}>
        <Grid2 container display="flex">
          <Grid2 size={openSmartData ? 6 : 12}>
            <DialogContent
              sx={{
                backgroundColor: colors.background,
            ...
            >
              ...
              {hasParents && (
                <ReceiveValueFromParent
                  ...
                  onSelectValue={handleHasPrentValue}
                />
              )}
